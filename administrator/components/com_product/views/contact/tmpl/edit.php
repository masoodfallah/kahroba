...
JFactory::getDocument()->addScriptDeclaration('
	Joomla.submitbutton = function(task)
	{
		if (task == "product.cancel" || document.formvalidator.isValid(document.getElementById("product-form")))
		{
			...
			if (task !== "product.apply")
			{
				window.parent.jQuery("#productEdit' . $this->item->id . 'Modal").modal("hide");
			}
		}
	};
');
...
<form action="<?php echo JRoute::_('index.php?option=com_product&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="product-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_PRODUCT_NEW_PRODUCT') : JText::_('COM_PRODUCT_EDIT_PRODUCT')); ?>
		<div class="row-fluid">
			<div class="span9">

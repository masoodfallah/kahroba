...
class ProductControllerProducts extends JControllerAdmin
{
	...
	public function featured()
	{
		...
		foreach ($ids as $i => $id)
		{
			...
			if (!JFactory::getUser()->authorise('core.edit.state', 'com_product.category.' . (int) $item->catid))
			{
		...
		if (empty($ids))
		{
			JError::raiseWarning(500, JText::_('COM_PRODUCT_NO_ITEM_SELECTED'));
		}
		else
		{
			// Publish the items.

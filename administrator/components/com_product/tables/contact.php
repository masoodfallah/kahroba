...
class ProductTableProduct extends JTable
{
	...
	{
		parent::__construct('#__product_details', 'id', $db);

		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_product.product'));
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_product.product'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		{
			$this->setError(JText::_('COM_PRODUCT_ERROR_UNIQUE_ALIAS'));
	...
	public function check()
	{
		...
		{
			$this->setError(JText::_('COM_PRODUCT_WARNING_PROVIDE_VALID_URL'));
		...
		if (trim($this->catid) == '')
		{
			$this->setError(JText::_('COM_PRODUCT_WARNING_CATEGORY'));
